<div class="card gallery" id="media-data">
	<div class="card-body media-tabs">
		<div>
			<ul class="nav nav-tabs nav-tabs-bottom">
				...
				<li class="nav-item">
					<a href="#crop" id="crop-img" class="nav-link" data-toggle="tab" aria-expanded="false">
						<span class="icon-crop mg-right-10"></span>
						<span>Tùy chỉnh ảnh tải lên</span>
					</a>
				</li>
			</ul>
			<div class="tab-content gallery-body" style="margin: 5px;">
						...
						<div class="list-body-scroll">
							<div v-for="(item, index) in pagination.data" v-tooltip :title="item.name" placement="left" class="item"  @click.stop.prevent="_select(item)" :class="{'active' : _isSelected(item.id)}">
								...
								{{-- <div class="btn-actions">
									<a href="#" class="btn"  @click.stop.prevent="_restore(item.id , index)">
										<i class="icon-trash text-danger"></i>
									</a>
									<a href="#" class="btn " @click.stop.prevent="_delete(item.id , index)">
										<i class="icon-pencil7 text-success"></i>
									</a>
								</div> --}}
							</div>
						</div>
				...
				<div class="tab-pane" id="upload">
					<div class="list-body">
						<div class="row">
							<input id="componentUpdateFile" class="d-none" type="file"  @change="_change($event)" accept="image/*" multiple="multiple">
