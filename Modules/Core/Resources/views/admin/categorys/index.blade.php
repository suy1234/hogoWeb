	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		...
		<div class="header-elements d-none">
			<div class="breadcrumb justify-content-center">
				<a href="{{ route('admin.categorys.create', ['code' => request()->code]) }}" class="btn {{ config('erp.btn_class.create.class') }} btn-sm btn-actions btn-create" style="margin-left: 5px;">
                ...
                <table class="table-hover table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('core::categorys.table.parent') }}</th>
                    ...
                    <tbody>
                        <tr v-if="!isLoading" v-for="(item, key) in data">
                            ...
                            <td>
                                ...
                                &nbsp;
                                <a :href="'{{ route("admin.categorys.edit", ['id' => '', 'code' => request()->code]) }}/'+item.id" class="text-primary" v-tooltip title="{{ trans('resource.edit') }}">
    ...
    var mix = {
        ...
        methods: {
            load: function(number = null ){
                ...
                helper.post( '{{ route('admin.categorys.index', ['code' => request()->code]) }}' , formdata ,15000)
            ...
            updateStatus: function(status) {
                ...
                helper.post( '{{ route("admin.categorys.status", ['code' => request()->code]) }}' , formdata ,15000)
                .done( function(res , status , xhr){
                    vm.isLoading = false;
                    if(res.success){
                        vm.load();
            ...
            destroy: function(id = '') {    
                ...
                var callbacktrue = function(){
                    ...
                    var formdata = new FormData;
                    formdata.append('ids' , vm.ids.toString());
                    helper.post( '{{ route("admin.categorys.destroy", ['code' => request()->code]) }}' , formdata ,15000)
                    .done( function(res , status , xhr){
                        vm.isLoading = false;
                        if(res.success){
                            vm.load();
