        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="{{ route('admin.settings.admin_app') }}" class="btn {{ config('erp.btn_class.update.class') }} btn-sm btn-actions btn-update" style="margin-left: 5px;">
                    ...
                    {{ trans('validation.attributes.update') }}
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_logo_background') }}:</label>
                            <form_color :color="form.navbar_logo_background" v-model="form.navbar_logo_background" /> 
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_background') }}:</label>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_background_hover') }}:</label>
                            <form_color :color="form.navbar_background_hover" v-model="form.navbar_background_hover" /> 
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_color') }}:</label>
                            <form_color :color="form.navbar_color" v-model="form.navbar_color" /> 
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_color_hover') }}:</label>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_top_background') }}:</label>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_top_background_hover') }}:</label>
                            <form_color :color="form.navbar_top_background_hover" v-model="form.navbar_top_background_hover" /> 
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_top_color') }}:</label>
                            <form_color :color="form.navbar_top_color" v-model="form.navbar_top_color" /> 
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label>{{ trans('core::settings.app.navbar_top_color_hover') }}:</label>
            ...
            <button v-on:click="update('{{ route('admin.settings.admin_app', ['reset' => true]) }}')" class="btn btn-warning btn-sm btn-actions btn-store" style="margin-left: 5px;">
                ...
                {{ trans('validation.attributes.reset') }}
            </button>
